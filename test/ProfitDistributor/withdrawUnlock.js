...
contract("ProfitDistributor.withdrawUnlock", function () {
  ...
  before(async function () {
    ...
    const distributorData = await deployments.deploy("ProfitDistributor.unlock", {
  ...
  it("withdraw: should return all reward to unlock period", async function () {
    ...
    assert.equal(locked, false, "Invalid locked flag");
